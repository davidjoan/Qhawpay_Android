...
public class FragmentCategory extends SherlockFragmentActivity {
	...
	public static class CategoryListLoader extends AsyncTaskLoader<List<Category>> {
		...
		public List<Category> loadInBackground() {
			try {
				...
				final String url = getContext().getString(R.string.base_uri)
						+ "/category/name/0/created_at/a/100/1.json";
				...
				List<Category> categories = responseEntity.getBody().getCategories();
	...
	public static class CategoryListFragment extends SherlockListFragment
		...
		public void onActivityCreated(Bundle savedInstanceState) {
			...
			mAdapter = new CategoryListAdapter(this.getActivity());
		...
		@Override
		public void onLoadFinished(Loader<List<Category>> loader,
				List<Category> data) {
